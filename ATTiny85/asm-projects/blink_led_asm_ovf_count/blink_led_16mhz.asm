...
Reset: 
   ldi temp,  0b00000101 ; (1 << CS02) | (1 << CS01) 
   ...
   ldi temp, 0b00000001
   sts TIMSK, temp      ; set the Timer Overflow Interrupt Enable (TOIE0) bit 
   ...
   sbi DDRB, 4           ; set PD4 to output

;======================
; Main body of program:

blink:
   sbi PORTB, (1 << PB0)          ; turn on LED on PD4     SBI PORTD, (1 << PD4)
   rcall delay           ; delay will be 1/2 second
   cbi PORTB, (1 << PB0)          ; turn off LED on PD4
   rcall delay           ; delay will be 1/2 second
